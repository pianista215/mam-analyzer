...
def all_engines_are_on(e: FlightEvent) -> bool:
	return all(state == "On" for state in get_engine_status(e))

def all_engines_are_off(e: FlightEvent) -> bool:
	return all(state == "Off" for state in get_engine_status(e))

def some_engine_is_on(e: FlightEvent) -> bool:
	return any(state == "On" for state in get_engine_status(e))

def some_engine_is_off(e: FlightEvent)-> bool:
	return any(state == "Off" for state in get_engine_status(e))
