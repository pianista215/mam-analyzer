...
AIRPORT_RUNWAYS = {
    ...
    "ENKR": [
        _rwy("05/23", 45.1,
             "05", 69.7220149, 29.8646882, 150, 5,
             "23", 69.7295565, 29.9215306, 296, 7),
    ],
    "ENDU": [
        _rwy("10/28", 45.1,
    ...
    "EFKT": [
        _rwy("16/34", 45,
             "16", 67.7119404, 24.8397481, 0, 0,
             "34", 67.6901033, 24.8539906, 0, 0),
    ],
    "EFKI": [
        _rwy("07/25", 48,
    ...
    "HUEN": [
        _rwy("12/30", 45,
             "12", 0.0511796, 32.4392908, 0, 0,
             "30", 0.0395631, 32.4577391, 0, 0),
        _rwy("17/35", 45,
             "17", 0.0556106, 32.4362327, 0, 0,
             "35", 0.0228576, 32.4407722, 0, 0),
    ],
    "HAAB": [
        _rwy("07L/25R", 45.1,
             "07L", 8.973982,  38.7823951, 250, 60,
             "25R", 8.9834158, 38.8146795, 378, 55),
        _rwy("07R/25L", 45.1,
             "07R", 8.9723303, 38.7834797, 362, 90,
             "25L", 8.982006,  38.8166456, 359, 90),
    ],
    "HKJK": [
        _rwy("06/24", 45.1,
             "06", -1.3275688, 36.9163805, 0, 60,
             "24", -1.3057105, 36.9462696, 0, 60),
    ],
    "FZAA": [
        _rwy("06/24", 60,
             "06", -4.3969322, 15.4270772, 0, 50,
             "24", -4.377396,  15.4573991, 0, 61),
    ],
    "CYQH": [
        _rwy("09/27", 45.7,
             "09", 60.1190097, -128.8367795, 0, 0,
             "27", 60.1138962, -128.8082671, 0, 0),
    ],
    "LEGE": [
        _rwy("01/19", 45.2,
             "01", 41.8949045, 2.7582592, 0, 59,
             "19", 41.9157115, 2.7661258, 157, 62),
    ],
    "PAWG": [
        _rwy("10/28", 46,
             "10", 56.4886166, -132.3825971, 0, 60,
             "28", 56.4800337, -132.3571613, 0, 60),
    ],
    "CYDL": [
        _rwy("02/20", 30.5,
             "02", 58.4171937, -130.0439007, 0, 0,
             "20", 58.4274262, -130.0192648, 124, 0),
    ],
    "CYHY": [
        _rwy("05/23", 45.7,
             "05", 60.839358, -115.7897967, 0, 0,
             "23", 60.8439996, -115.7694325, 0, 0),
        _rwy("14/32", 45.7,
             "14", 60.8472654, -115.7962433, 0, 30,
             "32", 60.8323545, -115.782047, 0, 30),
    ],
    "CYZF": [
        _rwy("10/28", 45.7,
             "10", 62.4711614, -114.4537378, 0, 0,
             "28", 62.4651684, -114.4271803, 0, 0),
        _rwy("16/34", 45.7,
             "16", 62.4732893, -114.4439831, 0, 0,
             "34", 62.4527925, -114.4408605, 0, 0),
    ],
    "LEVX": [
        _rwy("01/19", 45,
             "01", 42.2214547, -8.629606, 0, 0,
             "19", 42.2424481, -8.6238978, 0, 65),
    ],
    "LEBL": [
        _rwy("02/20", 45.1,
